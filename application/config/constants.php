...
define('table_secondary_user','secondary_user');
...
define('key_accessDetails', 'accessDetails');
define('key_id', 'id');
...
define('text_no_safe_area_found', 'no_safe_area_found');
...
define('key_shortprofile', 'shortprofile');
